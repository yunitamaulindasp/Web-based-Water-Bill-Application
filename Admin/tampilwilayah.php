<nav aria-label="breadcrumb" role="navigation">
	<ol class="breadcrumb adminx-page-breadcrumb">
		...
		<li class="breadcrumb-item active" aria-current="page">Daftar Wilayah Kota Batu</li>
	</ol>
</nav>
						
<div class="pb-3">
	<h1>Daftar Wilayah Kota Batu</h1>
</div>
					...
					<style>
						...
						<thead>
							<tr>
								...
								<th width="300px">Kelurahan/Desa</th>
...
<script type="text/javascript">
	...
	{	bootbox.confirm({
			title: "Konfirmasi",
			message: "ID Desa " + x + " dihapus?",
			callback: function(result){
				if (result == true)
				{	$.ajax({
						type: "GET",
						url: "hapuswilayah.php",
						data: { "ID" : x},
				})
